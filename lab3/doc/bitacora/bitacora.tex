...
\pagebreak 
\section*{Ejercicio 3}
Usando generate se pudo hacer una múltiplicación de 16 bits. Se utilizó el siguiente código para este ejercicio:
...
Y luego se probó la multiplicación de dos números 10 * 18  y se observó el resultado en los leds de la spartan 3E.
